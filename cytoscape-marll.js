...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["cytoscapeMarll"] = factory();
  else root["cytoscapeMarll"] = factory();
})(window, function () {
          ...
          var FDLayout = (function () {
            function FDLayout(options) {
              ...
              this.displacementThresholdPerNode =
                (1.0 * options.idealEdgeLength) / 100;
            ...
            _createClass(FDLayout, [
              {
                ...
                value: function calcSpringForce(edge, nodeID) {
                  ...
                  var springForce =
                    this.springConstant * (length - this.idealEdgeLength);
              ...
              },
              {
                ...
                value: function calcSpringForceFR(edge) {
                  ...
                  // Calculate spring forces
                  var springForce =
                    Math.pow(length - this.idealEdgeLength, 2) /
              ...
              },
              {
                ...
                value: function calcRepulsionForceFR(nodeA, nodeB) {
                  ...
                  var repulsionForce =
                    Math.pow(this.idealEdgeLength, 2) / distance;
              ...
              },
              {
                ...
                value: function calcStressPerNode(nodeA, nodeB) {
                  ...
                  var theoricDistance =
                    this.allPairsShortestPath[nodeA.ID][nodeB.ID];
                  if (theoricDistance && theoricDistance <= this.maxDistance) {
                    stress =
                      (1 / theoricDistance) *
                      Math.pow(
                        distance - theoricDistance * this.idealEdgeLength,
                        2
                      );
                  }
              ...
              },
              {
                ...
                value: function isConverged() {
                  ...
                  var stressConverged =
                    Math.abs(this.newStress - this.oldStress) / this.oldStress <
                    0.0001;
...
*/
          ...
          var assign = __webpack_require__(
            /*! ../../assign */ "./src/assign.js"
          );
          var defaults = __webpack_require__(
            /*! ./defaults */ "./src/layout/continuous-base/defaults.js"
          );
          var makeBoundingBox = __webpack_require__(
            /*! ./make-bb */ "./src/layout/continuous-base/make-bb.js"
          );

          var _require = __webpack_require__(
              /*! ./position */ "./src/layout/continuous-base/position.js"
            ),
          ...
          var _require2 = __webpack_require__(
              /*! ./tick */ "./src/layout/continuous-base/tick.js"
            ),
                  ...
                  return new Promise((resolve, reject) => {
                    ...
                    if (s.animateContinuously) {
                      var ungrabify = function ungrabify(node) {
                        ...
                        var grabbable = (getNodePositionData(
                          node,
                          s
                      ...
                      var updateGrabState = function updateGrabState(node) {
                        return (getNodePositionData(node, s).grabbed =
                          node.grabbed());
                      };
  ...
  \************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var setInitialPositionState = function setInitialPositionState(
            node,
            state
          ) {
            var p = node.position();
          ...
          module.exports = {
            setInitialPositionState: setInitialPositionState,
            getNodePositionData: getNodePositionData,
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var tick = function tick(state) {
            ...
            return (
              !s.infinite &&
              (tickIndicatesDone ||
                s.tickIndex >= s.maxIterations ||
                duration >= s.maxSimulationTime)
            );
          };
  ...
  \**********************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _FDLayout = __webpack_require__(
            /*! ./FDLayout */ "./src/layout/FDLayout.js"
          );

          var _continuousBase = __webpack_require__(
            /*! ./continuous-base/ */ "./src/layout/continuous-base/index.js"
          );
          ...
          var Layout = (function (_ContinuousLayout) {
            ...
            function Layout(options) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (Layout.__proto__ || Object.getPrototypeOf(Layout)).call(
                  this,
              ...
              if (
                !_this.state.maxDistance ||
                options.rewardFunction == "globalStress"
              ) {
              ...
              if (options.rewardFunction == "customReward") {
                _this.rewardFunction = function (n) {
                  return (
                    5 * _this.getEdgeLengthVariance(n) +
                    10 * _this.getNumberOfNodeOverlaps(n) +
                    _this.getNumberOfEdgeCrossings(n) +
                    _this.getAngleVariance(n) +
                    _this.getNodeDistanceVariance(n)
                  );
                };
                ...
                for (var i = 0; i < _this.state.nodes.length; i++) {
                  ...
                  for (var j = 0; j < _this.state.nodes.length; j++) {
                    ...
                    _this.state.allPairsShortestPath[nodeA.id()][nodeB.id()] =
                      shortestPaths(nodeA, nodeB);
                  }
                }
                _this.rewardFunction = _this.getCurrentLocalStress;
              } else if (options.rewardFunction == "globalStress") {
                _this.state.allPairsShortestPath =
                  _this.state.eles.floydWarshall().distance;
                ...
                _this.rewardFunction = function (n) {
                  return (
                    _this.getCurrentTotalForcesFR(n) +
                    _this.getCurrentLocalStress(n)
                  );
                };
              } else {
            ...
            _createClass(Layout, [
              ...
              },
              {
                ...
                value: function getNumberOfNodeOverlaps(node) {
                  ...
                  var boundingBox = function boundingBox(node) {
                    var scratch = node;
                    return {
                      x1: scratch.x - scratch.wHalf,
                      y1: scratch.y - scratch.hHalf,
                      x2: scratch.x + scratch.wHalf,
                      y2: scratch.y + scratch.hHalf,
                    };
                  };
              ...
              },
              {
                ...
                value: function getNumberOfEdgeCrossings(n) {
                  var doesIntersect = function doesIntersect(
                    a,
                    b,
                    c,
                    d,
                  ...
                  for (var i = 0; i < edges.length; i++) {
                    ...
                    for (var j = i + 1; j < edgeArray.length; j++) {
                      ...
                      if (
                        doesIntersect(p.x, p.y, q.x, q.y, r.x, r.y, s.x, s.y)
                      ) {
                        crosses++;
                      }
                    }
              ...
              },
              {
                ...
                value: function calcEdgeLengthVariance(edge) {
                  ...
                  // Calculate variance
                  return Math.pow(
                    (length - this.options.idealEdgeLength) /
              ...
              },
              {
                ...
                value: function calcNodeDistanceVariance(
                  sourceNode,
                  targetNode
                ) {
              ...
              },
              {
                ...
                value: function getAngleVariance(n) {
                  ...
                  for (var i = 0; i < length - 1; i++) {
                    variance += Math.pow(
                      Math.abs(this.calcAngle(arr[i], n, arr[i + 1])) -
                        (2 * Math.PI) / length,
                      2
                    );
                  }
                  ...
                  variance += Math.pow(
                    Math.abs(this.calcAngle(arr[length - 1], n, arr[0])) -
                      (2 * Math.PI) / length,
                    2
                  );
                  return variance;
              ...
              },
              {
                ...
                value: function tick() {
                  ...
                  if (
                    ...
                    this.state.currentIteration % 800 == 0
                  ) {
                    this.state.delta /= 2;
                  }
              ...
              },
              {
                ...
                value: function destroy() {
                  _get(
                    Layout.prototype.__proto__ ||
                      Object.getPrototypeOf(Layout.prototype),
                    "destroy",
                    this
                  ).call(this);
  ...
  \*****************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          module.exports = __webpack_require__(
            /*! ./continuous */ "./src/layout/continuous.js"
          );
